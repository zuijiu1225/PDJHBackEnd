<template>
  <div class="app-container">
    <el-card>
      ...
      <el-row>
        <el-form :model="QueryInput">
          <el-col :span="5" :xs="6" :sm="4" :md="4" :lg="4" :xl="4">
            <el-form-item label="患者编码">
              <el-input
                style="max-width: 70%"
                v-model="QueryInput.PatientCode"
              ></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="5" :xs="6" :sm="4" :md="4" :lg="4" :xl="4">
            <el-form-item label="患者姓名">
              <el-input
                style="max-width: 70%"
                v-model="QueryInput.PatientName"
                placeholder="支持模糊查询"
              ></el-input>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="6" :xs="6" :sm="4" :md="4" :lg="4" :xl="4">
    ...
    <!-- 登记排队弹窗 -->
    <el-dialog title="登记排队" :visible.sync="dialogRegsiterVisible">
      <el-row>
        <!-- 通过卡号查数据 -->
        <el-form
          :model="Patient"
          ...
          <el-row>
            <el-col :span="16">
              <el-form-item label="卡号" prop="PatientCardNo">
                <el-input
                  @keyup.enter.native="GetPatientByCardeNo('PatientCardForm')"
                  v-model="Patient.PatientCardNo"
                ></el-input>
              </el-form-item>
            </el-col>
            <el-col :span="8" style="padding-left: 20px">
              <el-button
                type="primary"
                :loading="QueryCardNoiSdisabled"
                @click.native="GetPatientByCardeNo('PatientCardForm')"
                size="small"
                >查询卡号</el-button
              >
            </el-col>
          ...
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="序号类别" prop="xhlb">
                <el-select v-model="Call.xhlb" placeholder="请选择序号类别">
          ...
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="医 生" prop="Doctors">
                <el-select v-model="Call.Doctors" placeholder="请选择医生">
                  <el-option
                    v-for="(item, index) in DoctorArry2"
                    :key="index"
                    :label="item.UserName"
                    :value="item.UserName"
                  ></el-option>
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button
          ...
          @click="RegisterCall('RegisterForm')"
          >确 定</el-button
        >
      </div>
    </el-dialog>
